...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="<?php echo base_url() . 'assets2/font-awesome/css/font-awesome.min.css'; ?>">
  <link rel="stylesheet" type="text/css" href="<?php echo base_url() . 'assets2/plugins/fullcalendar/fullcalendar.css'; ?>">
  <link rel="stylesheet" type="text/css" href="<?php echo base_url() . 'assets2/plugins/bootstrap-datepicker/css/bootstrap-datepicker3.min.css'; ?>">
</head>
...
<body>
  ...
  <nav class="navbar navbar-default">
    <div class="container-fluid">
      ...
      <center>
        <a href="admin">
          <img id="logo" src="<?php echo base_url() . 'img/pemkot.png' ?>" width="60" height="50">
        </a>
      </center>
    </div>
  </nav>
              ...
              <div class="portlet-body">
                <div class="table-toolbar">
                  <div class="row">
                    ...
                    <div class="col-md-12">
                      <div class="btn-group">
                        <a href="admin" class="btn btn-primary"> <i class="fa fa-home"></i> Back
                        </a>
                        <br>
                        <br>
                      </div>
...
<!--                           <div class="form-group">
                            ...
                            <div class="col-sm-10">
                              <div class="input-group input-medium date date-picker" data-date-format="yyyy-mm-dd" data-date-viewmode="years">
                                <input type="text" id="invalidDatess" name="end_date" class="form-control" readonly>
                                <span class="input-group-addon"><i class="fa fa-calendar font-dark"></i></span>
                              </div>
                            </div>
                          </div> -->
