					...
					<div class="col-lg-2">
						<div class="logo" style="float: right;">
							<a href="<?php echo base_url().'member'?>">
								<img src="<?php echo base_url().'img/pemkot.png' ?>" alt="IMG-LOGO" data-logofixed="<?php echo base_url().'img/pemkot.png' ?>"></a>
							</div>
						</div>

						<!-- Menu -->
						<div class="wrap_menu col-lg-10" style="float: right;">
							<nav class="menu">
								<?php if($this->session->userdata('nama_agt')) { ?>
									<ul class="main_menu">
										...
										<li>
											<a href="<?php echo base_url().'galery/testimoni'?>">Testimoni </a>
										</li>
											...
											<center>
												<li>
													<h4><a style="color: black;" 
														href="<?php echo base_url().'member/gantipass'?>">
														<i class="glyphicon glyphicon-lock" 
														style="color: black;" ></i>Ganti Password
													</a>
												</h4>
											</li>
										</center>
								...
								<li>
									<a class="btn4 flex-c-m size13 txt11 trans-0-4 m-l-r-auto" 
									style="width: 100px; height: 30px;" 
									href="<?php echo base_url().'admin/logout'?>">Logout</a>
								</li>      
							</ul>
									...
									<div class="social flex-w flex-l-m p-r-20">
										<center>
											<a href="<?php echo base_url().'welcome/login'?>" 
												class="btn4 flex-c-m size13 txt11 trans-0-4 m-l-r-auto" 
												style="width: 100px; height: 30px;"><b>LOGIN</b></a>
											</center>
