...
<section id="main-content">
  <section class="wrapper site-min-height">
    <h3><i class="fa fa-angle-right"></i>Tambah Konten</h3>
    <div class="row">
      <div class="col-lg-12">
        <div class="form-panel">

          <form action="<?php echo base_url() . 'admin/konten_act' ?>" class="form-horizontal style-form" method="post" enctype="multipart/form-data">
              ...
              <div class="col-lg-12">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-3 col-xs-11">
                    <input class="form-control form-control-inline input-medium " size="16" type="text" name="judul" class="form-control">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-8 col-xs-11">
                    <textarea class="form-control form-control-inline input-medium " size="16" rows="20" type="text" name="deskripsi" class="form-control"></textarea>
